...
• Materials (e.g., marble tile, custom vanity)
• Fixtures/Furniture (e.g., soaking tub, dual sinks, frameless shower)
• Lighting & Aesthetic (e.g., sconce lighting, modern-luxury look)
Estimate a reasonable renovation cost with a small price range and a disclaimer that it’s only an estimate. Then ask for the user’s budget and offer personalized design and budgeting recommendations.
"""
